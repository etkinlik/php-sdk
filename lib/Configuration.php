...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://etkinlik.io/api/v2';
    ...
    {
        $report  = 'PHP SDK (EtkinlikIo\Api) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2.0.11' . PHP_EOL;
