...
class FormatsApi
{
     ...
     * List formats
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listFormats'] to see the possible values for this operation
     *
    ...
    {
        list($response) = $this->listFormatsWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation listFormatsWithHttpInfo
     *
     * List formats
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listFormats'] to see the possible values for this operation
     ...
     */
    public function listFormatsAsync(string $contentType = self::contentTypes['listFormats'][0])
    {
        return $this->listFormatsAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listFormatsAsyncWithHttpInfo
     *
     * List formats
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listFormats'] to see the possible values for this operation
    ...
    /**
     * Create request for operation 'listFormats'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listFormats'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function listFormatsRequest(string $contentType = self::contentTypes['listFormats'][0])
    {
