...
class CitiesApi
{
    ...
    {
        list($response) = $this->listCitiesWithHttpInfo($contentType);
        return $response;
    }
     ...
     */
    public function listCitiesAsync(string $contentType = self::contentTypes['listCities'][0])
    {
        return $this->listCitiesAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function listCitiesRequest(string $contentType = self::contentTypes['listCities'][0])
    {
