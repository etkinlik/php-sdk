...
/**
 * NeighborhoodsApi Class Doc Comment
 *
 * @category Class
 * @package  EtkinlikIo\Api
 * @author   OpenAPI Generator team
...
class NeighborhoodsApi
{
    ...
    /**
     * Operation listDistrictNeighborhoods
     *
     * List neighborhoods by district
     *
     * @param  int $id District ID whose neighborhoods are requested. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listDistrictNeighborhoods'] to see the possible values for this operation
     *
    ...
    {
        list($response) = $this->listDistrictNeighborhoodsWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation listDistrictNeighborhoodsWithHttpInfo
     *
     * List neighborhoods by district
     *
     * @param  int $id District ID whose neighborhoods are requested. (required)
    ...
    /**
     * Operation listDistrictNeighborhoodsAsync
     *
     * List neighborhoods by district
     *
     * @param  int $id District ID whose neighborhoods are requested. (required)
     ...
     */
    public function listDistrictNeighborhoodsAsync($id, string $contentType = self::contentTypes['listDistrictNeighborhoods'][0])
    {
        return $this->listDistrictNeighborhoodsAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listDistrictNeighborhoodsAsyncWithHttpInfo
     *
     * List neighborhoods by district
     *
     * @param  int $id District ID whose neighborhoods are requested. (required)
    ...
    /**
     * Create request for operation 'listDistrictNeighborhoods'
     *
     * @param  int $id District ID whose neighborhoods are requested. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listDistrictNeighborhoods'] to see the possible values for this operation
     *
     ...
     */
    public function listDistrictNeighborhoodsRequest($id, string $contentType = self::contentTypes['listDistrictNeighborhoods'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling listDistrictNeighborhoods'
            );
        }


        $resourcePath = '/districts/{id}/neighborhoods';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
