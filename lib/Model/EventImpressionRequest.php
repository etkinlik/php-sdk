...
/**
 * EventImpressionRequest Class Doc Comment
 *
 * @category Class
 * @package  EtkinlikIo\Api
 * @author   OpenAPI Generator team
 ...
 */
class EventImpressionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EventImpressionRequest';
     ...
     * Sets user_agent
     *
     * @param string|null $user_agent Optional. When sent, stored on the impression record.
     *
     * @return self
     */
